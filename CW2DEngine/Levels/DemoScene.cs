...
{
    internal class DemoScene : Level
    {
        ...
        public DemoScene(string levelName) : base(levelName)
        {
        ...
        public override void OnLoad()
        {
            ...
            wall3 = new Wall(new Vector2(0, 400), new Vector2(20, 800), "wall");
            wall4 = new Wall(new Vector2(800, 400), new Vector2(20, 800), "wall");
